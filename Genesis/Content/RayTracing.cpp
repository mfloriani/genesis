...
RayTracing::RayTracing(const std::shared_ptr<DX::DeviceResources>& deviceResources)
...
void RayTracing::CreateDeviceDependentResources()
{
...
void RayTracing::ReleaseDeviceDependentResources()
{
	m_ready = false;
