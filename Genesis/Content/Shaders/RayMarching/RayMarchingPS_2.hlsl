...
float4 PhongIllumination(float3 surfacePoint, float3 normal, float shininess, float3 rayDirection, float4 diffuseColour)
{
...
outputPS main(PixelShaderInput input)
{
    ...
    output.colour = PhongIllumination(
			surfacePoint,
	        estimateGradiantNormal(surfacePoint),
	        40.0f,
	        eyeray.d,
	        float4(distanceAndColour.yzw, 1.0));
